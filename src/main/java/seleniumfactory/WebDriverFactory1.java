...
public class WebDriverFactory1 {
    ...
    public WebDriver getDriver(String browserName){
        return driverMap.getOrDefault(browserName.toLowerCase().trim(), () -> {
            System.out.println("Browser Name not found " + browserName);
            throw new RuntimeException("Browser Not Found, Please pass the correct browser");
        }).get();
    }
